...
We love your input! We want to make contributing to Freeport as easy and transparent as possible, whether it's:
...
2. **Setup**
   ```bash
   git clone https://github.com/reallyartificial/freeport.git
   cd freeport
   npm install
   ```
...
Example:
```
feat(brain): add multi-provider routing

Add intelligent routing across multiple AI providers
...
We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/reallyartificial/freeport/issues).
